...
<template>
    <div class="w-full">
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900">Add New Manager</h1>
                <p class="text-sm text-slate-500 mt-1">Fill in the details to create a new manager.</p>
            </div>
        </div>
