...
function destroy() {
    form.transform(() => ({ _method: 'DELETE' }))
        .post(`/admins/managers/${props.manager.id}`, {
            onSuccess: () => {
...
<template>
    <div class="w-full">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-900">Manager Details</h1>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                ...
                <div>
                    ...
                    <p class="font-medium text-slate-900">{{ manager.email }}</p>
                </div>

                <div>
                    <p class="text-sm text-slate-500">National ID</p>
                    <p class="font-medium text-slate-900">{{ manager.national_id }}</p>
                </div>
